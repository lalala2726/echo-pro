...
public class SysJobVo {
     ...
     * 调度策略描述
     */
    @Schema(description = "调度策略描述", type = "string", example = "Cron表达式")
    @Excel(name = "调度策略描述")
     ...
     * cron执行表达式
     */
    @Schema(description = "cron执行表达式", type = "string", example = "0 0 12 * * ?")
     ...
     * 固定频率间隔（毫秒）
     */
    @Schema(description = "固定频率间隔（毫秒）", type = "integer", example = "60000")
     ...
     * 固定延迟间隔（毫秒）
     */
    @Schema(description = "固定延迟间隔（毫秒）", type = "integer", example = "30000")
     ...
     * 初始延迟时间（毫秒）
     */
    @Schema(description = "初始延迟时间（毫秒）", type = "integer", example = "10000")
     ...
     */
    @Schema(description = "计划执行错误策略", type = "integer", example = "1")
    @Excel(name = "计划执行错误策略")
     ...
     * 失火策略描述
     */
    @Schema(description = "失火策略描述", type = "string", example = "立即执行")
    @Excel(name = "失火策略描述")
     ...
     * 任务参数
     */
    @Schema(description = "任务参数", type = "string", example = "{\"param1\":\"value1\"}")
    @Excel(name = "任务参数")
     ...
     * 依赖任务ID（多个用逗号分隔）
     */
    @Schema(description = "依赖任务ID", type = "string", example = "1,2,3")
    @Excel(name = "依赖任务ID")
     ...
     * 重试间隔（毫秒）
     */
    @Schema(description = "重试间隔（毫秒）", type = "integer", example = "5000")
    @Excel(name = "重试间隔（毫秒）")
     ...
     * 超时时间（毫秒）
     */
    @Schema(description = "超时时间（毫秒）", type = "integer", example = "60000")
    @Excel(name = "超时时间（毫秒）")
     ...
     * 开始时间
     */
    @Schema(description = "开始时间", type = "string", example = "2024-01-01 12:00:00")
     ...
     * 结束时间
     */
    @Schema(description = "结束时间", type = "string", example = "2024-12-31 23:59:59")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "结束时间")
     ...
     * 下次执行时间
     */
    @Schema(description = "下次执行时间", type = "string", example = "2024-01-02 12:00:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "下次执行时间")
     ...
     * 上次执行时间
     */
    @Schema(description = "上次执行时间", type = "string", example = "2024-01-01 12:00:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "上次执行时间")
