...
public class SysDictItemListRequest extends BasePageRequest {
     ...
     */
    @Schema(description = "关联字典编码", type = "string", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     */
    @Schema(description = "标签类型", type = "string", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String tagType;

    /**
     * 状态（1-正常，0-禁用）
     */
    @Schema(description = "状态（1-正常，0-禁用）", type = "integer", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
