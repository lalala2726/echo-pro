...
public class SysOperationLogListRequest extends BasePageRequest {
     ...
     * 请求方式
     */
    @Schema(description = "请求方式", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String requestMethod;

    /**
     * 操作IP
     */
    @Schema(description = "操作IP", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String operationIp;

    /**
     * 操作结果
     */
    @Schema(description = "操作结果", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String operationResult;

    /**
     * 操作模块
     */
    @Schema(description = "操作模块", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
