...
public class SysDictItemUpdateRequest {
     ...
     */
    @Schema(description = "关联字典编码，与sys_dict表中的dict_code对应", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     */
    @Schema(description = "标签类型，用于前端样式展示（如success、warning等）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Max(value = 1, message = "状态只能为1或0")
    @Min(value = 0, message = "状态只能为1或0")
