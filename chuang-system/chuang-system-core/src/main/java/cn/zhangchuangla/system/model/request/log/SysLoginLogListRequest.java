...
public class SysLoginLogListRequest extends BasePageRequest {
     ...
     * 账号状态
     */
    @Schema(description = "账号状态", example = "0", type = "integer", allowableValues = {"0", "1"}, requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     * ip地址
     */
    @Schema(description = "ip", example = "127.0.0.1", type = "string", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String address;

    /**
     * 地区
     */
    @Schema(description = "地址", example = "中国", type = "string", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     * 操作系统
     */
    @Schema(description = "操作系统", example = "Windows", type = "string", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String os;

    /**
     * 创建时间
     */
    @Schema(description = "创建时间", example = "2025-01-01 00:00:00", type = "date", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
