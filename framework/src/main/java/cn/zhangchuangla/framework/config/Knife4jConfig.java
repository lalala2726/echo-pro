...
public class Knife4jConfig {
    ...
    public GroupedOpenApi systemApi() {
        return GroupedOpenApi.builder()
                ...
                .group("系统管理")
                // 扫描的基础包路径
                .packagesToScan("cn.zhangchuangla.admin.controller.system")
                .build();
    }
    ...
    public GroupedOpenApi monitorApi() {
        return GroupedOpenApi.builder()
                ...
                .group("系统监控")
                // 扫描的基础包路径
                .packagesToScan("cn.zhangchuangla.admin.controller.monitor")
                .build();
    }
    ...
    public GroupedOpenApi commonApi() {
        return GroupedOpenApi.builder()
                ...
                .group("常用功能")
                // 扫描的基础包路径
                .packagesToScan("cn.zhangchuangla.admin.controller.common")
                .build();
    }
